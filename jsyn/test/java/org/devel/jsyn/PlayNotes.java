...
public class PlayNotes
{
    ...
    private void test()
    {
        ...
        // Set output latency to 123 msec because this is not an interactive
        // app.
        ...
        // synth.add( ugen = new com.syntona.exported.DualFMVoice() );
        // synth.add( ugen = new com.syntona.exported.NestedVoice() );
        // synth.add( ugen = new com.syntona.exported.FmEnvUnique() );
        // synth.add( ugen = new com.syntona.exported.FmEnvNick() );
