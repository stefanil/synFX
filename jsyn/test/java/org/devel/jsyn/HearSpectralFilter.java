...
public class HearSpectralFilter
{
	...
	{
		@Override
		public void processSpectrum( Spectrum inputSpectrum,
				Spectrum outputSpectrum )
		{
			inputSpectrum.copyTo( outputSpectrum );
			// zero out every other bin
			int size = outputSpectrum.getReal().length;
			for( int i = 0; i < size; i += 2 )
			{
				outputSpectrum.getReal()[i] = 0.0;
				outputSpectrum.getImaginary()[i] = 0.0;
			}
		}
	}
